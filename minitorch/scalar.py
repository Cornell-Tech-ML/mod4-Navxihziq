...
class Scalar:
    ...
    def parents(self) -> Iterable[Variable]:
        """Returns the parents of the current variable."""
        assert self.history is not None
        return self.history.inputs

    def chain_rule(self, d_output: Any) -> Iterable[Tuple[Variable, Any]]:
        """Applies the chain rule to the derivative of the output with respect to the input.

        Args:
        ----
            d_output: The derivative of the final output with respect to the output of the current function.

        Returns:
        -------
            The derivative of the input with respect to the output.
        ...
        return [
            (parent, derivative) for parent, derivative in zip(h.inputs, derivatives)
        ]
